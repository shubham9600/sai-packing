            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="contact.php" class="nav-item nav-link ">Contacte</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-barcode text-primary mb-4"></i>
                                <h5>Quality prouct</h5>
...
<!-- Mirrored from themewagon.github.io/restoran/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Oct 2023 14:29:55 GMT -->
</html>